        ...
        <nav className="nav">
            <div className="nav-header">
                <button className="menu-button">
                    <span className="avatar">
                        <img src="/teams/catalyst.svg" alt="Avatar" />
                    </span>
                    <span className="menu-title">Catalyst</span>
                    <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg" className="icon">
            ...
            <div className="nav-section">
                <a className="nav-link" href="/">
                    <svg viewBox="0 0 20 20" className="icon">
                        <path d="M9.293 2.293a1 1 0 0 1 1.414 0l7 7A1 1 0 0 1 17 11h-1v6a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1v-3a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v3a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1v-6H3a1 1 0 0 1-.707-1.707l7-7Z"></path>
                    </svg>
                    Home
                </a>
            ...
            <div className="nav-footer">
                <a className="nav-link" href="#support">
                    <svg viewBox="0 0 20 20" className="icon">
                        <path fillRule="evenodd" d="M18 10a8 8 0 1 1-16 0 8 8 0 0 1 16 0ZM8.94 6.94a.75.75 0 1 1-1.061-1.061 3 3 0 1 1 2.871 5.026v.345a.75.75 0 0 1-1.5 0v-.5c0-.72.57-1.172 1.081-1.287A1.5 1.5 0 1 0 8.94 6.94ZM10 15a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" clipRule="evenodd"></path>
                    </svg>
                    Support
                </a>
